                ...
                <div className="App">
                    <div className="App-header">
                        <div id="container" style={containerStyle}>
                            <aside id="sidePanel" style={panelStyle}>
                                <img
                                    src={logo}
                                    className="App-logo"
                                    alt="icon"
                                ...
                                >
                                    ...
                                    <br />
                                    <Link style={linkStyle} to="/imageNoAlt">
                                        Image without alt-text
                                    </Link>
                                    <br />
                                    <Link
                                        style={linkStyle}
                                        to="/meaningfulSequence"
                                    >
                                        Whitespaced table
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/orientation">
                                        Lock Orientation
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/inputPurpose">
                                    ...
                                    <Link
                                        ...
                                        to="/identifyPurpose"
                                    >
                                        No Purpose on Elements
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/useOfColor">
                                        No Use of Color
                                    </Link>
                                    <br />
                                    <Link
                                    ...
                                    <Link
                                        style={linkStyle}
                                        to="/insufficentContrast"
                                    >
                                        Insufficent Contrast
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/resizeText">
                                        No Resizing Text
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/imageOfText">
                                        Image of Text
                                    </Link>
                                    <br />
                                    <Link
                                    ...
                                    <br />
                                    <Link style={linkStyle} to="/textSpacing">
                                        Text Spacing
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/keyboard">
                                        Keyboard
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/keyboardTrap">
                                        Keyboard Trap
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/shortcut">
                                        Shortcut
                                    </Link>
                                    <br />
                                    <Link
                                    ...
                                    <br />
                                    <Link style={linkStyle} to="/pauseStopHide">
                                        Pause Stop Hide
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/threeFlashes">
                                        Three Flashes
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/bypassBlock">
                                        Bypass Block
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/focusOrder">
                                        Focus Order
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/linkPurpose">
                                        Link Purpose
                                    </Link>
                                    <br />
                                    <Link
                                    ...
                                    <br />
                                    <Link style={linkStyle} to="/labelInName">
                                        Label in name
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/pageLang">
                                        Page Language
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/partLang">
                                        Part Language
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/onInput">
                                        On Input
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/consistentNav">
                                        Consistitent Navigation
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/consistentId">
                                        Consistent Identification
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/errorID">
                                        Error Identification
                                    </Link>
                                    <br />
                                    <Link
                                        style={linkStyle}
                                        to="/labelsOrInstructions"
                                    >
                                        Labels or Instructions
                                    </Link>
                                    <br />
                                    <Link style={linkStyle} to="/nameRoleValue">
                                        Name Role Value
                                    </Link>
                                    <br />
                            ...
                            <main
                                id="inaccessibleContent"
                                style={inaccessibleContentStyle}
                            >
                                <Switch>
